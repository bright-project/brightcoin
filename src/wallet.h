...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 BRIGHTCOIN at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zBRIGHTCOIN send
enum ZerocoinSpendStatus {
    ZBRIGHTCOIN_SPEND_OKAY = 0,                            // No error
    ZBRIGHTCOIN_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZBRIGHTCOIN_WALLET_LOCKED = 2,                         // Wallet was locked
    ZBRIGHTCOIN_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZBRIGHTCOIN_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZBRIGHTCOIN_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZBRIGHTCOIN_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZBRIGHTCOIN_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZBRIGHTCOIN_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZBRIGHTCOIN_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZBRIGHTCOIN_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZBRIGHTCOIN_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZBRIGHTCOIN_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZBRIGHTCOIN_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZBRIGHTCOIN_SPENT_USED_ZBRIGHTCOIN = 14,                      // Coin has already been spend
    ZBRIGHTCOIN_TX_TOO_LARGE = 15                          // The transaction is larger than the max tx size
};
...
public:
    ...
    */
    ...
    void setZBrightCoinAutoBackups(bool fEnabled)
    {
