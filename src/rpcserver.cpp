...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BrightCoin features */
        {"brightcoin", "masternode", &masternode, true, true, false},
        {"brightcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"brightcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"brightcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"brightcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"brightcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"brightcoin", "startmasternode", &startmasternode, true, true, false},
        {"brightcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"brightcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"brightcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"brightcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"brightcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"brightcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"brightcoin", "mnbudget", &mnbudget, true, true, false},
        {"brightcoin", "preparebudget", &preparebudget, true, true, false},
        {"brightcoin", "submitbudget", &submitbudget, true, true, false},
        {"brightcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"brightcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"brightcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"brightcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"brightcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"brightcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"brightcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"brightcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"brightcoin", "mnsync", &mnsync, true, true, false},
        {"brightcoin", "spork", &spork, true, true, false},
        {"brightcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"brightcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use brightcoind, or the -server option to brightcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> brightcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39033/\n";
}
