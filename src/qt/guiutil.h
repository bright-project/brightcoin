...
/** Utility functions used by the BRIGHTCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render BRIGHTCOIN addresses in monospace font
...
// Parse "brightcoin:" URI into recipient object, return true on successful parsing
