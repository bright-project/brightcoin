...
public:
    ...
    void setZBrightCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBRIGHTCOIN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBRIGHTCOIN_clicked();
    void on_pushButtonZBrightCoinControl_clicked();
