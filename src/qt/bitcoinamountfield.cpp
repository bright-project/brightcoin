...
public:
    explicit AmountSpinBox(QWidget* parent) : QAbstractSpinBox(parent),
                                              currentUnit(BitcoinUnits::BRIGHTCOIN),
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::BRIGHTCOIN, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
