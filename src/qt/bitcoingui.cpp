                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BRIGHTCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and brightcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBRIGHTCOIN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BRIGHTCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about BRIGHTCOIN Core"));
    ...
    openAction->setStatusTip(tr("Open a BRIGHTCOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BRIGHTCOIN Core help message to get a list with possible BRIGHTCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BRIGHTCOIN Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BRIGHTCOIN Core"); // default title
