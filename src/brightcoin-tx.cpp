...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BrightCoin Core brightcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  brightcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded brightcoin transaction") + "\n" +
                               "  brightcoin-tx [options] -create [commands]   " + _("Create hex-encoded brightcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded brightcoin transaction
