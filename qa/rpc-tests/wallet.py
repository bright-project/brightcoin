...
#   c) node1 mines 32 blocks, so now node 0 has 60001brightcoin, node 1 has 4250brightcoin, node2 has none.
#   d) node0 sends 601 brightcoin to node2, in two transactions (301 brightcoin, then 300 brightcoin).
