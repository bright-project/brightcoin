Contributing to BRIGHTCOIN Core
============================

The BRIGHTCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BRIGHTCOIN Core project, and is not to be
confused with overall BRIGHTCOIN Network Protocol consensus changes.

Whether a pull request is merged into BRIGHTCOIN Core rests with the project merge
...
Patches that change BRIGHTCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the BRIGHTCOIN consensus, it must have been
...
The project leader is the release manager for each BRIGHTCOIN Core release.
