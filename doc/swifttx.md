...
This mechanism has been integrated into Bitcore-Node-BRIGHTCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BRIGHTCOIN-Project/insight-api-brightcoin#web-socket-api](https://github.com/BRIGHTCOIN-Project/insight-api-brightcoin#web-socket-api) 
* API: [https://github.com/BRIGHTCOIN-Project/insight-api-brightcoin#swifttx-transactions](https://github.com/BRIGHTCOIN-Project/insight-api-brightcoin#swifttx-transactions) 
...
By default, the BRIGHTCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BRIGHTCOIN Core daemon:
