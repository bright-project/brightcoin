...
In order to support loading of multiple wallets in brightcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is brightcoin.cpp.
...
Changes to brightcoin.cpp
----------------------
brightcoin.cpp is the entry point into brightcoin-qt, and as such, will require some minor modifications to provide hooks for
